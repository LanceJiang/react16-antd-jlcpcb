        ...
        <div className="content-wrap">
          ...
          <div className="bgc">
            ...
            <div className="main-btn-group">
              ...
              <Radio.Group className="formgroup" name="radiogroup" defaultValue={'2'}>
                {
                  [{
                    value: '1',
                    label: 'FR-4',
            ...
            <div className="main-btn-group">
              ...
              <Select className="mb15" defaultValue="1" style={{ width: 120 }} onChange={selectChange}>
                {
                  [{
                    value: '1',
                    label: 'label_1',
            ...
            <Collapse className="collapse" expandIconPosition="right" defaultActiveKey="1">
              <Panel header="PCB Specifications" key="1">
                <div className="main-btn-group">
                  <label className="label">Different Design
                    <Popover content={content}>
                      <Icon type="question-circle"/>
                    </Popover>
                  </label>
                ...
                <div className="main-btn-group">
                  <label className="label">Delivery Format
                    <Popover content={content}>
                      <Icon type="question-circle"/>
                    </Popover>
                  </label>
                ...
                <div className="main-btn-group">
                  <label className="label">PCB Thickness
                    <Popover content={content}>
                      <Icon type="question-circle"/>
                    </Popover>
                  </label>
                ...
                <div className="main-btn-group">
                  <label className="label">PCB Color
                    <Popover content={content}>
                      <Icon type="question-circle"/>
                    </Popover>
                  </label>
                  <Radio.Group className="formgroup" name="radiogroup" defaultValue={'2'}>
                    {
                      renderOptions(Array.from({length: 30}).map((_, i) => {
                        return {
                          label: i + 1,
                          value: i + 1
                        }
                ...
                <div className="main-btn-group">
                  <label className="label">Silkscreen
                    <Popover content={content}>
                      <Icon type="question-circle"/>
                    </Popover>
                  </label>
                  <Radio.Group className="formgroup" name="radiogroup" defaultValue={'2'}>
                    {
                      renderOptions(Array.from({length: 1}).map((_, i) => {
                        return {
                          label: 'White',
                          value: 1 + i
                        }
                ...
                <div className="main-btn-group">
                  <label className="label">Surface Finish
                    <Popover content={content}>
                      <Icon type="question-circle"/>
                    </Popover>
                  </label>
                  <Radio.Group className="formgroup" name="radiogroup" defaultValue={'2'}>
                    {
                      renderOptions(Array.from({length: 3}).map((_, i) => {
                        return {
            ...
            <Collapse className="collapse" expandIconPosition="right" defaultActiveKey="2">
              <Panel header="High-spec Options" key="2">
                {
                  [{
                    name: 'Outer Copper Weight',
                    options: [
                      {
                        label: '1 oz',
                        value: '0'
                    ...
                    return <div className="main-btn-group" key={group.name}>
                      <label className="label">{group.name}
                        <Popover content={content}>
                          <Icon type="question-circle"/>
                        </Popover>
                      </label>
                      <Radio.Group className="formgroup" name={`radiogroup_${group.name}`} defaultValue={'2'}>
                        {
            ...
            <Collapse className="collapse" expandIconPosition="right" defaultActiveKey="3">
              <Panel header="Advanced Options" key="3">
                {
                  [
                    {
                      name: '4-Wire Kelvin Test',
                      options: [
                        {
                          label: '1 oz',
                          value: '0'
                ...
                <div className="main-btn-group">
                  <label className="label"><span>PCB Remark
                  <Icon type="edit" style={{marginLeft: '4px'}} onClick={() => setEdit(!isEdit)}/></span></label>
          ...
          </div>
          {
            [{
              ...
              return <div key={v.name} className="switch-box mt20">
